...
## Project Structure
    ...
    ├── juanshareconnector2_1  # Django project configurations
...
1. Clone this repo and `cd juanshareconnector2_1`
...
2. Clone this repo and `cd juanshareconnector2_1`
